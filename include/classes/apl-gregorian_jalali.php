...
class APL_Gregorian_Jalali {
    
    public static function div($a,$b) { 
        return (int) ($a / $b); 
    } 

    public static function gregorian_to_jalali ($g_y, $g_m, $g_d,$str) 
    { 
    ...
    public static function jalali_to_gregorian($j_y, $j_m, $j_d,$str) 
    { 
        $g_days_in_month = array(31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31); 
        $j_days_in_month = array(31, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, 29); 
    ...
    public static function comparedate($_date_mix_jalaly,$_date_mix_gregorian)
    {
